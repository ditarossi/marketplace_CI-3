...
<body>
        ...
        <?php foreach($pengguna as $u){ ?>
			<form class="row g-3" action="<?php echo base_url(). 'index.php/Admin/editPengguna_aksi'; ?>" method="post">
                <div class="col-md-3">
					<label class="form-label">ID_Pengguna</label>
					<input class="form-control" name="ID_Pengguna" value="<?php echo $u->ID_Pengguna ?>">
				</div>
				<div class="col-md-3">
